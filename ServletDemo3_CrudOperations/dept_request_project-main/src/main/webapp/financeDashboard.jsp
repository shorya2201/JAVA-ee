...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<%
					ArrayList<ArrayList<String>> a = DbConnection.getRecordForFinance();
						...
						<%for(ArrayList<String> b: a){ %>
							<tr>
								...
								<%
									if(b.get(8).equals("Pending"))
									{
										out.println("<td><a href='approvalRecord.jsp?request_id="+b.get(0)+"&username="+username+"&dept=Finance&status=Approved' class='btn btn-info' onClick='''approval('Approved')'''>Approve</a></td>");
										out.println("<td><a href='approvalRecord.jsp?request_id="+b.get(0)+"&username="+username+"&dept=Finance&status=Denied' class='btn btn-danger'>Deny</a></td>");
